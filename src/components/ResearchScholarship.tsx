...
type TabType = 'research' | 'book-reports' | 'presentations' | 'assessment';
      ...
      <div className="container-custom">
        ...
        >
          <button
            ...
            className={`px-6 py-3 rounded-xl font-serif font-bold transition-all duration-300 ${activeTab === 'research'
          ...
          <button
            onClick={() => setActiveTab('book-reports')}
            className={`px-6 py-3 rounded-xl font-serif font-bold transition-all duration-300 ${activeTab === 'book-reports'
                ? 'bg-editorial-navy text-white shadow-md scale-105'
                : 'bg-white border border-editorial-border text-editorial-navy hover:border-editorial-accent hover:text-editorial-accent'
              }`}
          >
          ...
          <button
            ...
            className={`px-6 py-3 rounded-xl font-serif font-bold transition-all duration-300 ${activeTab === 'presentations'
                ? 'bg-editorial-navy text-white shadow-md scale-105'
                : 'bg-white border border-editorial-border text-editorial-navy hover:border-editorial-accent hover:text-editorial-accent'
              }`}
          >
          ...
          <button
            ...
            className={`px-6 py-3 rounded-xl font-serif font-bold transition-all duration-300 ${activeTab === 'assessment'
                ? 'bg-editorial-navy text-white shadow-md scale-105'
                : 'bg-white border border-editorial-border text-editorial-navy hover:border-editorial-accent hover:text-editorial-accent'
              }`}
          >
            ...
            >
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white p-8 border border-editorial-border shadow-sm hover:shadow-md transition-all duration-300 rounded-xl">
                  ...
                  <div className="space-y-3 text-editorial-subtext text-sm bg-editorial-bg p-6 border-l-2 border-editorial-accent rounded-r-xl">
                    ...
                    <button className="mt-4 px-5 py-2 bg-editorial-navy text-white text-sm hover:bg-editorial-accent transition-colors duration-300 rounded-lg font-serif">
                      Download PDF
                    </button>
                  </div>
                </div>
          ...
          {activeTab === 'book-reports' && (
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {/* Book Report 1 */}
                <div className="bg-white p-8 border border-editorial-border shadow-sm hover:shadow-md transition-all duration-300 flex flex-col rounded-xl">
                  ...
                  <button className="w-full px-4 py-3 border border-editorial-border text-editorial-navy hover:bg-editorial-bg hover:border-editorial-accent transition-all duration-300 text-sm uppercase tracking-wider rounded-lg font-serif">
                    View Full Report
                  </button>
                </div>
